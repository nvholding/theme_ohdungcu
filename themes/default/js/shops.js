...
function scrollToxx() {
	 ...
	 $('#product-tab .nav-item').removeClass('active');
	 $('#product-tab .tab-content .tab-pane').removeClass('active');
	 $('#product-tab .nav-item .content_rate').addClass('active');
	 $('#product-tab .tab-content .tab-pane.content_rate').addClass('active in');
	 return false;
 }
...
function onsubmitsearch(module) {
	...
	if (keyword == '' && cataid == 0 ) {
		...
		window.location.href = nv_base_siteurl + 'index.php?' + nv_lang_variable + '=' + nv_lang_data + '&' + nv_name_variable + '=' + module + '&' + nv_fc_variable + '=search_result&keyword=' + rawurlencode(keyword) + '&cata=' + cataid;
	}
	return false;
}
