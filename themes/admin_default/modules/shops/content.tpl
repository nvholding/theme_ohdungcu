...
<form class="form-horizontal" action="" enctype="multipart/form-data" method="post">
    ...
    <div class="row">
        <div class="col-sm-24 col-md-18">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">Cấu hình chiết khấu</div>
                <div class="panel-body">
                    <div class="form-group row">
                        <label class="col-md-6 control-label"><strong>Chiết khấu cho thành viên</strong></label>
                        <div class="col-md-10">
                            <input placeholder="Giá trị" type="number" step="0.1" value="{rowcontent.discount_member_amount}" name="discount_member_amount" class="form-control" />
                        </div>
                        <div class="col-md-8">
                            {SELECT_DISCOUNT_MEMBER}
                        </div>
                    </div>

                    <hr>
                    <h4><strong>CHIẾT KHẤU THEO SẢN PHẨM</strong></h4>
                    <div id="discount_num_pro">
                        <!-- BEGIN: discount_num_pro -->
                        <div class="form-group row">
                            <div class="col-md-6">
                                <input type="number" value="{DISCOUNT_NUM_PRO.min}" placeholder="Min" name="discount_num_pro[{DISCOUNT_NUM_PRO.k}][min]" class="form-control" />
                            </div>
                            <div class="col-md-6">
                                <input type="number" value="{DISCOUNT_NUM_PRO.max}" placeholder="Max" name="discount_num_pro[{DISCOUNT_NUM_PRO.k}][max]" class="form-control" />
                            </div>
                            <div class="col-md-6">
                                <input type="number" value="{DISCOUNT_NUM_PRO.amount}" placeholder="Giá trị" name="discount_num_pro[{DISCOUNT_NUM_PRO.k}][amount]" class="form-control" />
                            </div>
                            <div class="col-md-6">
                                {DISCOUNT_NUM_PRO.select}
                            </div>
                        </div>
                        <!-- END: discount_num_pro -->
                    </div>
                    <input type="button" class="btn btn-info" onclick="nv_add_discount_num_pro();" value="Thêm mức khác">
                </div>
            </div>

            <div class="panel panel-default">
                <div class="panel-heading">Cấu hình quà tặng</div>
                <div class="panel-body">
                    <div id="gift_info">
                        <!-- BEGIN: gift_info -->
                        <div class="form-group row">
                            <div class="col-md-6 control-label">
                                <input type="number" placeholder="Min" value="{GIFT_INFO.min}" name="gift_info[{DISCOUNT_NUM_PRO.k}][min]" class="form-control" />
                            </div>
                            <div class="col-md-6 control-label">
                                <input type="number" placeholder="Max" value="{GIFT_INFO.max}" name="gift_info[{DISCOUNT_NUM_PRO.k}][max]" class="form-control" />
                            </div>
                            <div class="col-md-12">
                                <textarea name="gift_info[{DISCOUNT_NUM_PRO.k}][content]" rows="3" class="form-control" placeholder="Nhập nội dung quà tặng">{GIFT_INFO.content}</textarea>
                            </div>
                        </div><hr>
                        <!-- END: gift_info -->
                    </div>
                    <input type="button" class="btn btn-info" onclick="nv_add_gift_info();" value="Thêm mức khác">
                </div>
            </div>
...
<script>
    var num_discount = {NUM_DISCOUNT_NUM_PRO};
    var gift_info = {NUM_GIFT_INFO};
    function nv_add_discount_num_pro() {
        num_discount = num_discount + 1;
        var html = '<div class="form-group row">' +
            '<div class="col-md-6">' +
            '<input type="number" placeholder="Min" name="discount_num_pro[' + num_discount + '][min]" class="form-control" />' +
            '</div>' +
            '<div class="col-md-6">' +
            '<input type="number" placeholder="Max" name="discount_num_pro[' + num_discount + '][max]" class="form-control" />' +
            '</div>' +
            '<div class="col-md-6">' +
            '<input type="number" placeholder="Giá trị" name="discount_num_pro[' + num_discount + '][amount]" class="form-control" />' +
            '</div>' +
            '<div class="col-md-6">' +
            '<select class="form-control" name="discount_num_pro[' + num_discount + '][type]">' +
        ...
        $('#discount_num_pro').append(html);
    }

    function nv_add_gift_info() {
        gift_info = gift_info + 1;
        var html = '<div class="form-group row">' +
            '<div class="col-md-6 control-label">' +
            '<input type="number" placeholder="Min" name="gift_info[' + gift_info + '][min]" class="form-control" />' +
            '</div>' +
            '<div class="col-md-6 control-label">' +
            '<input type="number" placeholder="Max" name="gift_info[' + gift_info + '][max]" class="form-control" />' +
            '</div>' +
            '<div class="col-md-12">' +
            '<textarea name="gift_info[' + gift_info + '][content]" rows="3" class="form-control" placeholder="Nhập nội dung quà tặng"></textarea>' +
            '</div>' +
            '</div><hr>';

        $('#gift_info').append(html);
    }
</script>
