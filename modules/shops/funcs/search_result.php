...
$base_url = NV_BASE_SITEURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&' . NV_NAME_VARIABLE . '=' . $module_name . '&amp;' . NV_OP_VARIABLE . '=search_result&keyword=' . $keyword . '&cata=' . $cataid . $url;
$html_pages = nv_generate_page($base_url, $num_items, $per_page, $page);

$array_mod_title[] = array(
    'catid' => 0,
    'title' => $lang_module['product_keywords'],
    'link' => $base_url
);
...
if (count($data_content) == 0) {
    ...
    $contents .= view_search_all($data_content, $compare_id, $html_pages, $data_review);
}
