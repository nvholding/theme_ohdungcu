...
if (empty($contents)) {
    ...
    if ($global_array_shops_cat[$catid]['viewcat'] == 'view_home_cat' and $global_array_shops_cat[$catid]['numsubcat'] > 0) {
        ...
        foreach( $data_content['data'] as $id_item )
        {
            $array_id_item[] = $id_item['id'];
        }
        ...
        $contents = call_user_func($global_array_shops_cat[$catid]['viewcat'], $data_content, $compare_id, $pages, $sorts, $viewtype, $data_review);
    }
